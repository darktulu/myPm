...
public class BusinessGoals implements java.io.Serializable {
    ...
    public BusinessGoals(int golasId,String empAppriasals,String employe, String goalsTitle, String goalsDetails, Double goalWeight,
	    String midYearReview, Integer summaryRating,String status_Appraisal) {
