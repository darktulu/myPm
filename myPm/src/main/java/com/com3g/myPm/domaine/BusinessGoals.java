...
/**
 * BusinessGoals generated by hbm2java
 */
@Entity
...
public class BusinessGoals  implements java.io.Serializable {
    ...
    public BusinessGoals(BusinessGoalsId id, String goalsTitle, String goalsDetails, Double goalWeight, String midYearReview, Integer summaryRating) {
       this.id = id;
