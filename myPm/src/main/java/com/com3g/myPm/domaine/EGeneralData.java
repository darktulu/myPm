...
public class EGeneralData implements java.io.Serializable {
    ...
    public EGeneralData(String username, String efId) {
	this.username = username;
	this.efId = efId;
    }

    public EGeneralData(String username, String efId, String name, String surname, String idPhoto, String email,
	    Date birthday, String cin, String cnss, String martialStatus, String gender, String cimr,
	    String homeAdress, String businessPhoneNumber, String businessFax, String contactInformation,
	    String emergencyContact, String skypeId, String imId, String bankName, String bankAccount, String status,
	    String passportid, Date passportEpireDate, String driveLiecenceId, String driveLicencetype, String pecName,
	    String pecNumber, String secName, String secNumber, String PMobile, String SMobile, String hmePhoneNumber,
	    String country, String region, String iesourcing, String jobeTitle, String grade, String ladder,
	    String tercel, Date lastModified, String matricule, String matriculeInssurance, String secondaryMailAdresse) {
	this.username = username;
	this.efId = efId;
	this.name = name;
