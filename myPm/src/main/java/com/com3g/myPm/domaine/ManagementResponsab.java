...
/**
 * ManagementResponsab generated by hbm2java
 */
@Entity
...
public class ManagementResponsab  implements java.io.Serializable {
    ...
    public ManagementResponsab(ManagementResponsabId id, String mrTitle, String mrDetails, double mrWeight, int summaryRating) {
       this.id = id;
